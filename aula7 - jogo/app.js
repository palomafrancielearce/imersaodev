...
function sortearCarta() {
  ...
  //funcao para remover uma posicao de um array/vetor
  //passamos a posição do array que queremos excluir e o segundo parametro é a quantidade de cartas que queremos excluir a partir do indic
...
//essa funcao esta marcada no botão pelo onClick=proximaRodada()
var divCartas = document.getElementById("cartas");
divCartas.innerHTML = `<div id="carta-jogador" class="carta"></div> <div id="carta-maquina" class="carta"</div>`;
//utilizando crase nao preciamos concatenar com mais
...
//com o codigo acima limpamos a div para a proxima rodada
}